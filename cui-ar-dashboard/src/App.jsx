...
function CustomersView({ customers, ar, onCustomer, mgmtCompanies, onMgmt }) {
        ...
        <table style={{width:"100%",borderCollapse:"collapse",fontSize:13}}>
          <thead>
            <tr style={{background:"#f9fafb",borderBottom:"1px solid #e5e7eb"}}>
              {["Customer","Mgmt Company","Outstanding","Terms","Tier","Avg Pay","Risk","Last Action",""].map(h=>(
    ...
    <div style={{display:"flex", height:"100vh", background:"#f4f6fa", fontFamily:"'DM Sans',system-ui,sans-serif", overflow:"hidden"}}>
      ...
      <div style={{flex:1, display:"flex", flexDirection:"column", overflow:"hidden"}}>
        ...
        <div style={{flex:1,overflowY:"auto",padding:24}}>
          ...
          {view==="customers" && !profileKey && <CustomersView customers={customers} ar={ar} onCustomer={openCustomer} mgmtCompanies={mgmtCompanies} onMgmt={openMgmtProfile}/>}
